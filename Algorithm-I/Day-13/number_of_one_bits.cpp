 ...
 * is the same, whether it is signed or unsigned. In Java, the compiler represents
...
int main() {
        ...
        assert(solution.hammingWeight(1 << 18) == 1);
        assert(solution.hammingWeight((1 << 18) | (1 << 2)) == 2);
        assert(solution.hammingWeight((1 << 18) - 1) == 18);
        return 0;
}